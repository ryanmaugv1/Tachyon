...
class Setup():
    ...
    def mac_osx_install_route(self):
        ...
        tachyon executable and adding it to the /usr/local/bin directory
        """

        # CHOMD +X Changes the permissions of the file to make it executable
    ...
    def linux_install_route(self):
        ...
        This method will install the tachyon languageon a mac by making a tachyon executable
        and adding it to the /usr/local/bin directory

        NOTE: This is a copy paste of the mac_osx_install_route.
        """
        os.system("chmod +x ./src/main.py")
        print("| Set Tachyon Executable Permission                 [X]|")
